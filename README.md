...
First, you'll need to install Cargo.<br>
Then `git clone` the repository.<br>
Then `cd` into it and execute `cargo run`.<br>
You need to install Cargo, it's not a default thing (almost forgot about that part)
